  ...
  const categories = [
    {
      ...
      description: 'Engaging 2D animations and motion graphics',
      path: '/portfolio/animations/2d'
    },
    {
      id: '3d',
      title: '3D Animations',
      image: '/images/portfolio/animations/3d-cover.jpg',
      description: 'Stunning 3D animations and visual effects',
      path: '/portfolio/animations/3d'
    }
  ];
